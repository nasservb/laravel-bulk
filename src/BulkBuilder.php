...
namespace nasservb\LaravelBulk;
...
class BulkBuilder
{
     ...
     * @return void
     */
    public function __construct(\Illuminate\Redis\Connections\Connection $connection)
    {
    ...
    /**
     * Execute the given callback if cached items count is equal to max item count,
     *  if call the failure callback.
     *
